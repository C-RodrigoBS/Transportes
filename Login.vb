Public Class Login
    ...
    Private Sub Panel1_Paint(sender As Object, e As PaintEventArgs) Handles PanelLogin.Paint

    End Sub

    Private Sub Bienvenido_Click(sender As Object, e As EventArgs) Handles Bienvenido.Click
